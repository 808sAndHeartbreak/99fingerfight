...
本项目根目录为 `D:\code\99 fingerfight`，GitHub 为 https://github.com/808sAndHeartbreak/99fingerfight 。请保留整个项目；`public/` 仅含静态素材，不能单独构建或运行联机游戏。当前规则版本 15、协议版本 2，前后端必须配套发布。
