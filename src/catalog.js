export const WEAPONS = Object.freeze([
  {"id": "serious", "recipe": [0, 0], "name": "认真一拳", "damage": 30, "detail": "破坏所有护盾，造成 30 点真实伤害；跳过自己下个回合"},
  {"id": "drunken", "recipe": [0, 0], "name": "醉拳", "damage": 25, "detail": "造成 10～40 点随机普通伤害"},
  ...
  {"id": "claw", "recipe": [4, 4], "name": "爪击", "damage": 10, "detail": "造成 10 点真实伤害"},
  ...
  {"id": "knuckles", "recipe": [6, 6], "name": "指虎", "damage": 0, "detail": "永久获得每段直接技能伤害 +10，不叠加"},
  {"id": "steal", "recipe": [7, 7], "name": "窃取", "damage": 0, "detail": "夺走对手全部道具，最多持有 3 个；复制对手双手数字"},
  ...
  {"id": "unify", "recipe": [9, 9], "name": "归一", "damage": 0, "detail": "双方双手归 1，自己获得一枚九；累计两枚立即获胜"},
