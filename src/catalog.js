export const WEAPONS = Object.freeze([
  ...
  {"id": "steal", "recipe": [7, 7], "name": "窃取", "damage": 0, "detail": "夺走对手全部道具及增益（和平、指虎、酒、肾上腺素）；道具最多持有 3 个，溢出舍弃"},
...
export const PROPS = Object.freeze({
  ...
  lock: { name:"封印", detail:"一只手不能参与触碰计算，至其所属玩家回合结束", target:"hand", image:"ink-mono/lock.webp" },
  ...
  balance: { name:"制衡", detail:"先消耗此道具；双方各自重抽剩余道具，数量不变", target:"all", image:"ink-mono/balance.webp" },
  boon: { name:"天降的宝札", detail:"双方道具补至 3 个", target:"all", image:"ink-mono/boon.webp" },
  greed: { name:"强欲", detail:"获得 2 个道具（最多持有 3 个），立即结束回合", target:"self", image:"ink-mono/greed.webp" },
  grace: { name:"恩惠", detail:"回复自己双手数字总和的生命", target:"self", image:"ink-mono/grace.webp" },
  ruin: { name:"破坏", detail:"造成对手双手数字总和的伤害，无视且不消耗护盾", target:"enemy", image:"ink-mono/ruin.webp" },
});
