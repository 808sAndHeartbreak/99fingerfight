export function menuMarkup(page, {started=false, online=false}={}) {
 ...
 const pages={
  home:{label:'',title:'',body:button('开始游戏','data-menu="play"')+button('玩法说明','data-menu-help')+button('设置','data-menu-settings')},
