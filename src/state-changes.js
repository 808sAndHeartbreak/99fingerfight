...
export const STATUS_NAMES=Object.freeze({echo:'回响',mirror:'镜像',silenced:'沉默',skip:'跳过',seven:'七伤',dark:'玄冥',foam:'盾墙',knuckles:'指虎',peace:'和平',weak:'虚弱',poison:'中毒',wine:'酒',resilience:'坚韧',nine:'归一次数'});
