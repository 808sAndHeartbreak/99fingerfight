...
export const LESSONS = [
 {title:'走完一个攻防回合',result:'手雷原伤害 30，被 [5] 护盾减半，只扣 15 HP；格挡后 [5] 退为 [1]。真实伤害可以绕过数字护盾。把对手 HP 清空即可获胜。接着看看另一种胜利方式。',steps:[
  {title:'先用 [3] 碰对手的 [1]',detail:'正式开局双方都是 [1] / [1]。现在模拟一段连续攻防：你是 [3] / [6]，对手是 [1] / [1]。先用 [3] 碰 [1]，得到 [4]。',command:{type:'add',hand:0,targetHand:0},target:'#hand-0-0',selectedTarget:'#hand-1-0'},
