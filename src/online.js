...
export function onlineMarkup(net){
 ...
 } else if(p?.queued)body=`<div class="match-search" role="status"><div class="search-orbit" aria-hidden="true">VS</div><b>正在寻找对手</b><span>找到对手后自动开局，请留在这里。</span></div><button id="online-cancel" class="secondary" ${disabled}>取消匹配</button>`;
